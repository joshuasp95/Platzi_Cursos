use curso-java-spring-jpa-platzi-pizzeria;
...
DECLARE WITH_ERRORS BOOLEAN DEFAULT FALSE;
...
IF WITH_ERRORS THEN SET order_taken = FALSE;

ROLLBACK;

ELSE SET order_taken = TRUE;
